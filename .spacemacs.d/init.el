...
values."
  (setq-default
   ...
   '(
     ...
     evil-snipe ;; two character motions
     ;; better-defaults
     ;; ivy
     emacs-lisp
     git
...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/Dropbox/dissertation/phd.org" "~/Dropbox/jobs/nsf/src/project.org" "~/Dropbox/notes/Jobs.org" "~/Dropbox/notes/Admin.org")))
